...
class _$_Task implements _Task {
  _$_Task(
      ...
      @JsonKey(name: 'task_progress_id') this.taskProgressId,
      this.isFavorite,
      this.schedule});
  ...
  @override
  String toString() {
    return 'Task(id: $id, title: $title, description: $description, pillarId: $pillarId, embedUrl: $embedUrl, frequency: $frequency, imgUrl: $imgUrl, taskProgressId: $taskProgressId, isFavorite: $isFavorite, schedule: $schedule)';
  }
